...
![Login](/private/login.jpg?raw=true "Login - landing page")

### Create Team

![Create Team](/private/create-team.jpg?raw=true "Create team")

### Tool bar area

Use the tool bar to navigate between Sequent core functions. Tap or click on one of the 3 icons to navigate. 

![Toolbar](/private/toolbar.jpg?raw=true "Toolbar")
...
![Retro Board](/private/main_board.jpg?raw=true "Main retro board")

### Actions
You can add, change delete actions here.

![Retro Board](/private/actions.jpg?raw=true "Managing actions")

### Tools

![Tools](/private/actions.jpg?raw=true "Tools")
...
- Preferences - Sequent customization options
