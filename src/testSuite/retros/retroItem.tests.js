...
if (Meteor.isClient) {
    ...
    describe('Retro Item', function () {
        ...
        it('displays default correctly ', async function () {
            ...
            const item = {
                data: await TestData.fakeRetroItem(),
        ...
        it('displays votes correctly ', async function () {
            ...
            const fakeRetro = await TestData.fakeRetro()
            ...
            const item = {
                data: await TestData.fakeRetroItem({ votes: 3 }),
                unHighlight: sandbox.stub(),
                selectedItemId: selectedVar
            }
        ...
        it('hides vote correctly ', async function () {
            sandbox.stub(Meteor, 'user').returns(fakeUser)

            Retros.insert(await TestData.fakeRetro({ status: Constants.RetroStatuses.ARCHIVED }))
