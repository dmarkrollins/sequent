...
if (Meteor.isClient) {
    ...
    describe('Action Item', function () {
        ...
        it('displays correctly - unselected pending', function () {
            sandbox.stub(Meteor, 'user').returns(fakeUser)

            const selectedVar = new ReactiveVar(null)

            const item = {
                data: TestData.fakeRetroAction({ status: Constants.RetroItemStatuses.PENDING }),
        ...
        it('displays correctly - unselected complete', function () {
            sandbox.stub(Meteor, 'user').returns(fakeUser)

            const selectedVar = new ReactiveVar(null)

            const item = {
                data: TestData.fakeRetroAction({ status: Constants.RetroItemStatuses.COMPLETE }),
                unHighlight: sandbox.stub(),
                selectedItemId: selectedVar
            }
        ...
        it('pending selected item has edit and delete buttons', function () {
            sandbox.stub(Meteor, 'user').returns(fakeUser)
        ...
        it('pending selected item - delete button works properly', function () {
            sandbox.stub(Meteor, 'user').returns(fakeUser)
        ...
        it('pending selected item - edit button works properly', function () {
            sandbox.stub(Meteor, 'user').returns(fakeUser)
        ...
        it('pending selected item - cancel button works properly', function () {
            sandbox.stub(Meteor, 'user').returns(fakeUser)
