...
if (Meteor.isServer){
    ...
    describe('Toggle Action Method', function (){
        ...
        it('found action is toggled - PENDING - stubbed', function(){
        ...
        it('found action is toggled - COMPLETE - stubbed', function(){

            const fakeId = Random.id()

            const fakeAction = TestData.fakeRetroAction({ _id: fakeId, status: Constants.RetroItemStatuses.COMPLETE })
